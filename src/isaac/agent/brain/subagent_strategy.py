...
class SubagentPromptStrategy(PromptStrategy):
    ...
    def __init__(
        ...
        *,
        ...
        self._runner_helper = StrategyPromptRunner(env)
    ...
    async def handle_prompt(
        ...
        _push_chunk = self._runner_helper._make_chunk_sender(session_id)  # type: ignore[attr-defined]
        _push_thought = self._runner_helper._make_thought_sender(session_id)  # type: ignore[attr-defined]
        ...
        base_handler = self._runner_helper._build_runner_event_handler(  # type: ignore[attr-defined]
            session_id,
            tool_trackers,
        ...
        if response_text is None:
            return self._runner_helper._prompt_cancel()  # type: ignore[attr-defined]
        if response_text.startswith("Provider error:"):
            ...
            return self._runner_helper._prompt_end()  # type: ignore[attr-defined]
