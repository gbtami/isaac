...
async def test_model_build_failure_surfaces_error(monkeypatch, tmp_path: Path):
    ...
    monkeypatch.setattr("isaac.agent.brain.subagent_prompt.create_subagent_for_model", _raise_model_error)
    monkeypatch.setattr("isaac.agent.brain.subagent_prompt.create_subagent_planner_for_model", _raise_model_error)
